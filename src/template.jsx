...
const TableData = [
  {
    ...
    price: "$4.012",
    color: "#DD6107",
    image: "/admin/dashboard/user2.png",
  ...
  },
  {
    ...
    price: "$2.092",
    customer: "Omar Griffith",
    image: "/admin/dashboard/user3.png",
    color: "#10B860",
  },
  {
    id: 12807,
    ...
    price: "$1.089",
    customer: "Omar Griffith",
    image: "/admin/dashboard/user4.png",
    color: "#10B860",
  },
  {
    id: 12806,
    ...
    price: "$833",
    customer: "Omar Griffith",
    image: "/admin/dashboard/user5.png",
    color: "#4F80E1",
  },
  {
    id: 12805,
    ...
    price: "$1.458",
    customer: "Omar Griffith",
    image: "/admin/dashboard/user6.png",
    color: "#FB4949",
  },
];
const chatImages = [
  "/admin/dashboard/user10.png",
  "/admin/dashboard/user11.png",
  "/admin/dashboard/user12.png",
  "/admin/dashboard/user13.png",
  "/admin/dashboard/user14.png",
];
const productData = [
  {
    product: "Apple Macbook Pro...",
    ...
    revenue: "$51,440",
    rating: "4.82",
    image: "/admin/dashboard/apple.png",
  },
  {
    product: "iBox iPhone 14Pro...",
    price: "120",
    ...
    revenue: "$17,123",
    rating: "3.22",
    image: "/admin/dashboard/ibox.png",
  },
  {
    product: "Apple Macbook Pro...",
    price: "223",
...
const messages = [
  ...
  {
    image: "/admin/dashboard/user7.png",
    name: "Nettie Barnett",
    message: "Great service by Dominik... ",
    alt: "user7",
  },
  {
    image: "/admin/dashboard/user8.png",
    name: "Junaid Horn",
    message: "Just come back to home...",
    alt: "user8",
  },
  {
    image: "/admin/dashboard/user9.png",
    name: "Angus Thomson",
...
const cardData = [
  {
    type: "Total Profit",
    percentage: "50.43%",
    arrow: "/admin/dashboard/uparrow.svg",
    graph: "/admin/dashboard/graph1.svg",
    price: "$ 329.50",
  },
  {
    type: "Total Revenue",
  ...
  },
  {
    type: "Total Visitors",
    percentage: "10.89%",
    arrow: "/admin/dashboard/downarrow.svg",
    graph: "/admin/dashboard/graph3.svg",
    price: "$ 200.00",
  },
  {
    type: "Product Sold",
    percentage: "20.92%",
    arrow: "/admin/dashboard/uparrow.svg",
    graph: "/admin/dashboard/graph4.svg",
    price: "$ 200.00",
  },
];
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-start gap-3">
                      <div className="max-h-6 max-w-[22px]">
                        <img
                          src="/admin/dashboard/user10.png"
                          alt="user"
                          className="min-w-[22px] min-h-[22px]"
                        />
                      </div>
                  ...
                  <div className="mt-3.5 w-full flex gap-3.5">
                    ...
                    <div className="flex items-center gap-3">
                      <img
                        src="/admin/dashboard/mic.svg"
                        alt="mic"
                        className="min-w-[14px] min-h-[14px] cursor-pointer"
                      />
                      <img
                        src="/admin/dashboard/dots.svg"
                        alt="dots"
